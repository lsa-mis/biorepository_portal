...
{table: "items", specify_field: "minimumElevationInMeters", rails_field: "minimum_elevation_in_meters", caption: ""},
{table: "items", specify_field: "maximumElevationInMeters", rails_field: "maximum_elevation_in_meters", caption: ""},
